                  ...
                  Container(
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(
                          children: [
                            Text(userInfo.user_name,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold,fontSize: 18),),
                            Text(userInfo.gender,style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),),
                            // Text(userInfo.age.toString(),style: TextStyle(color: Colors.black,fontWeight: FontWeight.bold),)
                          ],
                        )
                      ],
                    ),

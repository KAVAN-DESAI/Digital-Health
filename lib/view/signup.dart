                ...
                actions: <Widget>[
                  FlatButton(
                    ...
                    onPressed: () async{
                      ...
                      if(user != null){
                        userInfo.user_name=_nameController.text;
                        userInfo.userPhoneNumber==_phoneController.text;
                        Navigator.pushReplacement(context, MaterialPageRoute(
                            builder: (context) => HomeScreen(phone_number: _phoneController.text,name:_nameController.text)
                        ));
                      }else{
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Image.asset(
                    'assets/images/illustration-2.jpeg',
                     fit: BoxFit.cover,
                  ),
                ),
                SizedBox(
                ...
                Text(
                  "Add your name and phone number. OTP will be sent to your mobile number",
                  style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.bold,
